...
public class MovieBuddyApplication {
    ...
    public void run(String[] args) throws Exception {
        ...
        commandActions.put(Command.Quit, arguments -> {
            output.println(messageSource.getMessage("application.commend.quit",new Object [0],Locale.getDefault()));
            running.set(false);
        });
        ...
        commandActions.put(Command.DirectedBy, arguments -> {
            ...
            output.println(messageSource.getMessage("application.commend.directedBy",new Object[]{director},Locale.getDefault()));
            moviesDirectedBy.forEach(it -> {
                String data = String.format(messageSource.getMessage("application.commend.directedBy.format",new Object[0],Locale.getDefault()), counter.getAndIncrement(), it.getTitle(), it.getReleaseYear(), it.getDirector(), it.getWatchedDate().format(Movie.DEFAULT_WATCHED_DATE_FORMATTER));
                output.println(data);
            });
            output.println(messageSource.getMessage("application.commend.directedBy.count",new Object[]{moviesDirectedBy.size()},Locale.getDefault()));
        });
        ...
        commandActions.put(Command.releasedYearBy, arguments -> {
            ...
            output.println(messageSource.getMessage("application.commend.releasedYearBy",new Object[]{releaseYear},Locale.getDefault()));
            moviesReleasedYearBy.forEach(it -> {
                String data = String.format(messageSource.getMessage("application.commend.directedBy.format",new Object[0],Locale.getDefault()), counter.getAndIncrement(), it.getTitle(), it.getReleaseYear(), it.getDirector(), it.getWatchedDate().format(Movie.DEFAULT_WATCHED_DATE_FORMATTER));
                output.println(data);
            });
            output.println(messageSource.getMessage("application.commend.releasedYearBy.count",new Object[]{moviesReleasedYearBy.size()},Locale.getDefault()));
        });
        ...
        output.println();
        output.println(messageSource.getMessage("application.ready",new Object[0], Locale.KOREAN));
